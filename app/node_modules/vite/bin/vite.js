#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\t5169\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.523\\out\\buildHook\\index.js').default({tool: 'vite', checkSum: '20d64732ee53e3e9018914UxgHGQMIB1YBAQNRXQlRUg1dUFUF', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/t5169/.vscode/extensions/wallabyjs.console-ninja-1.0.523/out/buildHook/index.js').then(m => m.default.default({tool: 'vite', checkSum: '20d64732ee53e3e9018914UxgHGQMIB1YBAQNRXQlRUg1dUFUF', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
...
function start() {
  try {
    ...
    setTimeout(() => {
      try {
        // eslint-disable-next-line n/no-unsupported-features/node-builtins -- it is supported in Node 22.12.0+ and only called if it 